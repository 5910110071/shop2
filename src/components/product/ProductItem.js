    ...
    render() {
        ...
        return (
            <div className="col-md-3 col-sm-6">
                ...
                {this.props.onSelectProduct && <button className="btn btn-block btn-secondary btn-sm mt-2" onClick={() => this.props.onSelectProduct(this.props.product)}>เลือก</button>}
